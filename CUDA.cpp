...
__device__ double fun1 (double x1, double y1, double z1, double RE1delay,double RE1delay2) // cos1,cos2,sin1,sin2
{
       return (0.5*tn*((Go1*(z1-No1)/(1.0 + eps1*(x1*x1 + y1*y1))) - gammap1)*(x1-(alpha1*y1)) + 
       tn*kappa1*RE1delay+ tn*kappa2*RE1delay2);
}

__device__ double fun2 (double x1, double y1, double z1, double IE1delay, double IE1delay2) // RE1delay,RE1delay2
{
       return (0.5*tn*((Go1*(z1-No1)/(1.0 + eps1*(x1*x1 + y1*y1))) - gammap1)*((alpha1*x1)+y1) + 
       tn*kappa1*IE1delay + tn*kappa2*IE1delay2);
}

__device__ double fun3 (double x1, double y1, double z1,double J1)
{
